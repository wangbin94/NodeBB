<h1><i class="fa fa-envelope-o"></i>Parse Push Plugin</h1>
...
<form role="form" class="parse-settings">
	<fieldset>
		<div class="row">
			<div class="col-sm-6">
...
<script type="text/javascript">
	require(['settings'], function(Settings) {
		Settings.load('parse_push', $('.parse-settings'));

		$('#save').on('click', function() {
			Settings.save('parse_push', $('.parse-settings'), function() {
